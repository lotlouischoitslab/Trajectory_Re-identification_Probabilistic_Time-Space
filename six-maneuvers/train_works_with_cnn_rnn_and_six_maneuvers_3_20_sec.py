...
trSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/20-seconds/train', t_h=30, t_f=200, d_s=2)
valSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/20-seconds/valid', t_h=30, t_f=200, d_s=2)
...
torch.save(net.state_dict(), 'trained_models_20_sec/cslstm_m.tar')
