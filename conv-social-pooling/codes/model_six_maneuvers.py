...
class highwayNet_six_maneuver(nn.Module):
    ...
    def __init__(self,args):
        super(highwayNet_six_maneuver, self).__init__()
        ...
        self.op_maneuver = torch.nn.Linear(self.soc_embedding_size + self.dyn_embedding_size, self.num_lon_classes*self.num_lat_classes)
