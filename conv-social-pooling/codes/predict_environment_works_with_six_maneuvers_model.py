...
model_directory = 'models/highwaynet-5-sec-101-80-speed-maneuver-for-GT-six-maneuvers/cslstm_m.tar'

saving_directory = 'predicted_data'
batch_size = 128
...
# predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/train', t_h=30, t_f=50, d_s=2)
# predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/valid', t_h=30, t_f=50, d_s=2)
predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/test', t_h=30, t_f=50, d_s=2)
...
with open("data_points.data", "wb") as filehandle:
	pickle.dump(np.array(data_points), filehandle, protocol=4)

with open("fut_predictions.data", "wb") as filehandle:
	pickle.dump(np.array(fut_predictions), filehandle, protocol=4)

with open("maneuver_predictions.data", "wb") as filehandle:
