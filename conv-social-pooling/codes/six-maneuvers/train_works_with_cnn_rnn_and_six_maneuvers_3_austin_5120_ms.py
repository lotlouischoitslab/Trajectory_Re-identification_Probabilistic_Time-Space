...
args['in_length'] = 21 # 40*0.08 = 3.20 , input is 40 steps
args['out_length'] = 32 # 64x0.08 = 5.12 , output is 64 steps
args['grid_size'] = (13,3)
...
trSet = ngsimDataset('/reza/projects/trajectory-prediction/data/Austin/5120_miliseconds/train', t_h=40, t_f=64, d_s=2)
valSet = ngsimDataset('/reza/projects/trajectory-prediction/data/Austin/5120_miliseconds/valid', t_h=40, t_f=64, d_s=2)
...
torch.save(net.state_dict(), 'trained_models_austin_5120_ms/cslstm_m.tar')
