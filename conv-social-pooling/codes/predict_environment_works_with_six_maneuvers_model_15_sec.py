...
model_directory = 'models/highwaynet-15-sec-101-80-speed-maneuver-for-GT-six-maneuvers/cslstm_m.tar'

# saving_directory = 'predicted_data/highwaynet-15-sec-101-80-speed-maneuver-for-GT-six-maneuvers/'
saving_directory = 'predicted_data/highwaynet-15-sec-101-80-speed-maneuver-for-GT-six-maneuvers/test/'
batch_size = 128
...
# predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/15-seconds/train', t_h=30, t_f=150, d_s=2)
# predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/15-seconds/valid', t_h=30, t_f=150, d_s=2)
predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/15-seconds/test', t_h=30, t_f=150, d_s=2)

predDataloader = DataLoader(predSet,batch_size=batch_size,shuffle=True,num_workers=8,collate_fn=predSet.collate_fn)
lossVals = torch.zeros(75).cuda()
counts = torch.zeros(75).cuda()
