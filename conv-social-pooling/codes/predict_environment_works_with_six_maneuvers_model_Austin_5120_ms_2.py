...
args['in_length'] = 21 # 40*0.08 = 3.20 , input is 40 steps, 40//2 + 1 = 21
args['out_length'] = 32 # 64x0.08 = 5.12 , output is 64 steps, 64//2 = 32
args['grid_size'] = (13,3)
...
model_directory = 'models/highwaynet_six_maneuvers_austin_5120_ms/cslstm_m.tar'
# saving_directory = 'predicted_data/highwaynet-5120-ms-Austin-six-maneuvers/test/'
# saving_directory = 'predicted_data/highwaynet-5120-ms-Austin-six-maneuvers/train/'
saving_directory = 'predicted_data/highwaynet-5120-ms-Austin-six-maneuvers/valid/'
batch_size = 128
...
# predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/Austin/5120_miliseconds/test', t_h=40, t_f=64, d_s=2)
# predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/Austin/5120_miliseconds/train', t_h=40, t_f=64, d_s=2)
predSet = ngsimDataset('/reza/projects/trajectory-prediction/data/Austin/5120_miliseconds/valid', t_h=40, t_f=64, d_s=2)

# predDataloader = DataLoader(predSet,batch_size=batch_size,shuffle=True,num_workers=8,collate_fn=predSet.collate_fn)
predDataloader = DataLoader(predSet,batch_size=batch_size,shuffle=False,collate_fn=predSet.collate_fn)
lossVals = torch.zeros(32).cuda()
counts = torch.zeros(32).cuda()
