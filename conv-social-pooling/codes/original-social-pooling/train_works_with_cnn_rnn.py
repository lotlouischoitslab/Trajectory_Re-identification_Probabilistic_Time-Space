...
from utils_works_with_cnn_rnn import ngsimDataset,maskedNLL,maskedMSE,maskedNLLTest
...
trSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/train', t_h=30, t_f=50, d_s=2)
valSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80-speed-maneuver-for-GT/valid', t_h=30, t_f=50, d_s=2)
