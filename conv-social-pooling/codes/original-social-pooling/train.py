...
trSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80/train', t_h=30, t_f=200, d_s=2)
valSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80/valid', t_h=30, t_f=200, d_s=2)
# trSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80/train', t_h=30, t_f=50, d_s=2)
# valSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80/valid', t_h=30, t_f=50, d_s=2)
# trSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80/train')
# valSet = ngsimDataset('/reza/projects/trajectory-prediction/data/NGSIM/101-80/valid')
